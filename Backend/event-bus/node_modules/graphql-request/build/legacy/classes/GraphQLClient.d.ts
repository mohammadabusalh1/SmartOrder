...
import type { BatchRequestDocument, BatchRequestsOptions, BatchResult } from 'graphql-request/src/legacy/functions/batchRequests.js';
import type { RequestDocument, RequestOptions, VariablesAndRequestHeadersArgs } from 'graphql-request/src/legacy/helpers/types.js';
import { type GraphQLClientResponse, type RawRequestOptions, type RequestConfig, type Variables } from 'graphql-request/src/legacy/helpers/types.js';
/**
 * GraphQL Client.
 */
